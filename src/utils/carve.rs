...
pub async fn search(query: String) -> Result<(), Box<dyn std::error::Error>> {
...
pub async fn fetch_slider_items() -> Result<(), Box<dyn std::error::Error>> {
...
async fn scrape_news(url: &str, select_path: &str) -> Result<News, Box<dyn std::error::Error>> {
